    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://analytics.boxfordpartners.com https://va.vercel-scripts.com https://*.clerk.accounts.dev https://clerk.titlewise.app https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.bunny.net; font-src 'self' https://fonts.bunny.net; img-src 'self' data: blob: https://img.clerk.com; connect-src 'self' https://analytics.boxfordpartners.com https://*.clerk.accounts.dev https://clerk.titlewise.app https://va.vercel-scripts.com https://static.cloudflareinsights.com https://*.neon.tech; frame-src https://*.clerk.accounts.dev https://clerk.titlewise.app; object-src 'none'; base-uri 'self'",
          },
        ],
      },
    ]
