    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-3xl px-6 pt-32 pb-20 lg:px-8">
        ...
        <div className="mt-12 space-y-8 text-[#0d253d] font-light leading-relaxed">
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Services</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Accounts</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Acceptable Use</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Payments and Subscriptions</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Intellectual Property</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Confidentiality</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Disclaimer of Warranties</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Limitation of Liability</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Indemnification</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Governing Law</h2>
          ...
          <div>
            <h2 className="mb-3 text-[22px] font-light tracking-[-0.22px] text-[#0d253d]">Changes to These Terms</h2>
